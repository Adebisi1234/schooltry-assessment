...
// Define the type for $page.props.auth
interface Auth {
    user: User;
}

// Explicitly type $page
const $page = defineProps<{ props: { auth: Auth } }>();
</script>

<template>
    <Head title="Welcome to Ed-tech">
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        ...
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">Welcome to Ed-tech</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Your AI powered learning platform <br />Features</p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span> For teachers and students to create, share, and learn from each other. </span>
                        </li>
                        <li
                        ...
                        >
                            ...
                            <span> AI powered learning experience with personalized content recommendations and chatbot. </span>
                        </li>
                    </ul>
                ...
                <img
                    src="/logo.jpg"
                    alt="Ed-tech logo"
                    class="relative -mb-px aspect-335/376 size-full w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] object-cover lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]"
                />
            </main>
        </div>
