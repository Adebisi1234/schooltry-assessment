...
const props = withDefaults(defineProps<Props & { auth: Auth }>(), {
    breadcrumbs: () => [],
});

// Explicitly type $page
const page = usePage<{ auth: Auth; breadcrumbs: BreadcrumbItem[] }>();
    ...
    <div>
        <div class="border-sidebar-border/80 border-b">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <Link :href="route('documents')" class="flex items-center gap-x-2">
                    <AppLogo />
                </Link>
